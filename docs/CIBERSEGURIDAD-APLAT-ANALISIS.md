# Análisis completo: Ciberseguridad en GURU

Documento que analiza la parte de ciberseguridad de GURU: los tres pilares (Auditoría Ciberseguridad, Ciber, Hack), su estado real, por qué no están desplegados públicamente y qué valor aportan a la plataforma y a la valoración.

---

## 1. Resumen ejecutivo

- **En el sitio GURU** la sección **Ciberseguridad** (`#ciberseguridad`) muestra tres pilares: **Auditoría Ciberseguridad**, **Ciber** y **Hack**.
...
- Forman parte de la **capacidad y el portafolio** de GURU: demuestran conocimiento en pentest, monitoreo, cumplimiento normativo (OACI, P-CS) y framework de seguridad. Suman a la valoración como **activos técnicos y diferenciadores**.
...
| **Valor para GURU** | Servicio de **consultoría y auditoría** facturable (pentest, informes, propuesta de valor). Recurrente. Referencia en NEGOCIO-APLAT y servicios: 2.000 – 8.000 USD por proyecto. |
...
| **Valor para GURU** | **Cumplimiento normativo** (P-CS, OACI), monitoreo Fortinet. Diferenciador en aviación y sectores regulados. Base para ofrecer “monitoreo de ciberseguridad” como servicio o producto empaquetado si en el futuro se decide desplegar para terceros. |
...
| **Valor para GURU** | Demuestra **capacidad en seguridad operacional**: políticas, respuesta a incidentes, integración con Fortinet y red. Refuerza el mensaje “ciberseguridad como prioridad” y la oferta de consultoría (documentación, planes de mejora). |
...
- Son productos/sistemas **en uso** (corren cuando se necesitan), pero **no publicados en internet** como servicio abierto porque:
  ...
  - **Alcance deliberado:** no se ha buscado exponerlos como SaaS o landing pública; se mantienen como capacidad interna y como demostración de portafolio en el sitio GURU.
- En la web de GURU ya se aclara: *“Sistemas independientes · No desplegados públicamente”* y cada tarjeta lleva la etiqueta *“Sistema independiente”*.
