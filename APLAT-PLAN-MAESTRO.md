# APlat — Plan Maestro: Portafolio, Servicios y Plataforma

**Objetivo:** Organizar el portafolio de proyectos, definir la oferta de servicios digitales de APlat y preparar la presentación para inversión y venta.
...
| **Apps / productos** | RayPremios, Cuadrernos, CuadernosOficial, BAMVino, MundoIAanime, BotArbi, memoria, mi-app-guru, gvx-demo | Apps específicas, bots, IA, vino, premios, cuadernos |
...
- **Valor para APlat:** Base reutilizable para “centros de mando” y dashboards empresariales; referencia de seguridad y auth moderna.
...
- **Valor para APlat:** Caso estrella: plataforma de venta de vuelos + intranet empresarial; muestra capacidad full-stack, integraciones GDS y sistemas corporativos.
...
- **Valor para APlat:** Servicio de “control de acceso + recepción digital” para oficinas y edificios.
...
- **Valor para APlat:** Producto “reportes y control contable desde Excel” para PYMEs o cadenas; base para servicios de automatización de datos.

#### Resto de repos (inferido por nombre y contexto)
- **JCavalier:** Posible panel/admin o producto con marca.
- **RayPremios, Cuadrernos, CuadernosOficial:** Productos de premios y cuadernos (apps/web).
...
## 2. Catálogo de servicios APlat (qué vender)
...
2. **Documento “Portafolio APlat” (PDF o Notion)**
...
3. **Pitch para inversión**
   ...
   - Solución: “APlat como marca que agrupa servicios digitales y portafolio ordenado.”
...
### Fase 2 — Plataforma APlat (sitio + portafolio) (4–8 semanas)

4. **Landing / sitio APlat**
   - Home: qué es APlat, propuesta de valor, servicios (enlaces al catálogo).
...
6. **Convertir proyectos en “productos”**
   - Definir 2–3 “productos empaquetados” (ej.: “Control de acceso APlat”, “Reportes desde Excel APlat”) con precio o paquete base.
...
7. **Procesos internos**
   ...
   - Repositorio o doc interno “APlat – Procesos” para que cualquier dev pueda alinearse.

---

## 4. Alcance de lo que desarrollaremos (plataforma APlat)

### 4.1 Sitio web APlat (prioridad 1)
...
2. **Crear** en este repo la estructura del sitio APlat (por ejemplo `apps/web` o `sites/aplat`) con Next.js + Tailwind.
3. **Redactar** los textos del Home, Servicios y Portafolio (una versión corta por proyecto).
4. **Definir** nombre de dominio y marca (logo, colores) para APlat.
5. **Programar** una revisión del Plan Maestro con el inversionista (reunión o documento compartido).

---

## 6. Estructura sugerida del repositorio APlat

```
APlat/
├── README.md                 # Descripción del proyecto APlat
├── APLAT-PLAN-MAESTRO.md     # Este documento
├── docs/
│   ├── portafolio.md         # Lista detallada de proyectos (tabla)
│   ├── servicios.md          # Catálogo de servicios
│   └── pitch.md              # Guion o bullets del pitch
├── sites/
│   └── aplat-web/            # Next.js site (landing + portafolio)
│       ├── app/
│       ├── components/
│       └── package.json
